                    ...
                    child: SingleChildScrollView(
                      child: Text.rich(TextSpan(
                          ...
                          children: <TextSpan>[
                            ...
                            TextSpan(text: ' and ', style: const TextStyle(fontSize: 18, color: Colors.black), children: <TextSpan>[
                              TextSpan(
                                  text: 'Privacy Policy',
                                  style: const TextStyle(fontSize: 18, color: Colors.black, decoration: TextDecoration.underline),
                                  recognizer: TapGestureRecognizer()
                                    ..onTap = () {
